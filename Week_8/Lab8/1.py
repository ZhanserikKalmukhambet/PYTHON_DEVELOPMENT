...
# the end of the game
game_over = pygame.transform.scale(pygame.image.load(os.path.join('images','game_over.jpg')),(WIDTH,HEIGHT))

score = pygame.transform.scale(pygame.image.load(os.path.join('images','score.png')),(200,100))
cnt_score = 0

level = pygame.transform.scale(pygame.image.load(os.path.join('images','level.gif')),(200,120))
cnt_level = 1
