...
bg = pygame.transform.scale(pygame.image.load(os.path.join('images','micky.jpeg')),(WIDTH, HEIGHT))

sec_img = pygame.image.load(os.path.join('images','clock_sec.png'))
x_sec, y_sec = WIDTH/2 + 7, HEIGHT/2 - 5

min_img = pygame.image.load(os.path.join('images','clock_min.png'))
